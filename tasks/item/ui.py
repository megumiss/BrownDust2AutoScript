...
SWITCH_ITEM_TAB.add_state(
    KEYWORDS_ITEM_TAB.UpgradeMaterials, check_button=UPGRADE_MATERIAL_CHECK, click_button=UPGRADE_MATERIAL_CLICK
)
SWITCH_ITEM_TAB.add_state(KEYWORDS_ITEM_TAB.LightCone, check_button=LIGHT_CONE_CHECK, click_button=LIGHT_CONE_CLICK)
SWITCH_ITEM_TAB.add_state(KEYWORDS_ITEM_TAB.Relics, check_button=RELICS_CHECK, click_button=RELICS_CLICK)
SWITCH_ITEM_TAB.add_state(
    KEYWORDS_ITEM_TAB.OtherMaterials, check_button=OTHER_MATERIALS_CHECK, click_button=OTHER_MATERIALS_CLICK
)
SWITCH_ITEM_TAB.add_state(
...
SWITCH_ITEM_TAB.add_state(KEYWORDS_ITEM_TAB.Missions, check_button=MISSIONS_CHECK, click_button=MISSIONS_CLICK)
SWITCH_ITEM_TAB.add_state(KEYWORDS_ITEM_TAB.Valuables, check_button=VALUABLES_CHECK, click_button=VALUABLES_CLICK)
SWITCH_ITEM_TAB.add_state(KEYWORDS_ITEM_TAB.Pet, check_button=PET_CHECK, click_button=PET_CLICK)
# Tabs in synthesize
SWITCH_ITEM_TAB.add_state(
    KEYWORDS_ITEM_TAB.MaterialExchange, check_button=MATERIAL_EXCHANGE_CHECK, click_button=MATERIAL_EXCHANGE_CLICK
)
    ...
    def _item_ui_insight_aside(self, state: ItemTab):
        ...
        if state in [
            ...
            if SWITCH_ITEM_TAB.is_state_insight(KEYWORDS_ITEM_TAB.UpgradeMaterials, main=self):
                return
            if SWITCH_ITEM_TAB.is_state_insight(
                KEYWORDS_ITEM_TAB.Valuables, main=self
        ...
        if state in [
            ...
            if SWITCH_ITEM_TAB.is_state_insight(KEYWORDS_ITEM_TAB.Pet, main=self):
                return
            if SWITCH_ITEM_TAB.is_state_insight(
                KEYWORDS_ITEM_TAB.UpgradeMaterials, main=self
