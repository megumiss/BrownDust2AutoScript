...
class StoredGenerated:
    ...
    Item_Past_Evils_of_the_Borehole_Planet_Disaster = StoredPlanner(
        'Dungeon.Planner.Item_Past_Evils_of_the_Borehole_Planet_Disaster'
    )
    ...
    BattlePassSimulatedUniverse = StoredBattlePassSimulatedUniverse(
        'BattlePass.BattlePassStorage.BattlePassSimulatedUniverse'
    )
    ...
    BattlePassQuestSynthesizeConsumables = StoredBattlePassQuestSynthesizeConsumables(
        'BattlePass.BattlePassStorage.BattlePassQuestSynthesizeConsumables'
    )
    BattlePassQuestStagnantShadow = StoredBattlePassQuestStagnantShadow(
        'BattlePass.BattlePassStorage.BattlePassQuestStagnantShadow'
    )
    BattlePassQuestCavernOfCorrosion = StoredBattlePassQuestCavernOfCorrosion(
        'BattlePass.BattlePassStorage.BattlePassQuestCavernOfCorrosion'
    )
    BattlePassQuestTrailblazePower = StoredBattlePassQuestTrailblazePower(
        'BattlePass.BattlePassStorage.BattlePassQuestTrailblazePower'
    )
