...
- **ダンジョン攻略**：[キャラクター育成計画](https://github.com/megumiss/BrownDust2AutoScript/wiki/Planner_cn)、デイリーダンジョン、ダブルイベントダンジョン、歴戦流転。
...
- **クラウドゲーム**：（中国版のみ）[クラウド崩壊スターレイルでBD2ASを実行](https://github.com/megumiss/BrownDust2AutoScript/wiki/Cloud_cn)

## インストール [![](https://img.shields.io/github/downloads/megumiss/BrownDust2AutoScript/total?color=4e4c97)](https://github.com/megumiss/BrownDust2AutoScript/releases)

[中国語インストールガイド](https://github.com/megumiss/BrownDust2AutoScript/wiki/Installation_cn)、自動インストールチュートリアル、使用方法、手動インストールチュートリアルを含む。
...
- [ミニマップ認識原理](https://github.com/megumiss/BrownDust2AutoScript/wiki/MinimapTracking)
...
BD2ASはアズールレーンスクリプト[AzurLaneAutoScript](https://github.com/LmeSzinc/AzurLaneAutoScript)をベースに開発されています。Alasは3年の開発を経て高い完成度に達していますが、技術的負債も蓄積されており、新プロジェクトでこれらの問題を解決したいと考えています。
